...
import Main.Main;
import Ruangan.Komunal;

public class Frame_Pinjam_Komunal_ListPeminjaman extends JFrame implements ActionListener,WindowListener{
	...
	private JLabel lbl_title = new JLabel("List Peminjaman Komunal");
	
	private Frame_Pinjam_Komunal_FormPeminjaman form_peminjaman;
	private Frame_Pinjam_List pinjam_list;
	private Main main;
	
    private JTable table;
    private String[] column = {"Tanggal","Mulai","Selesai","Nama","Kelas","Gender","Lantai"};
...
//    	}
		...
		main.sort_komunal();
		System.out.println(main.getList_komunal().size());
		for(Komunal x : main.getList_komunal()) {
			...
			String jumlah_tungku = Integer.toString(x.getLantai());
...
//		pnl_north.setBorder(BorderFactory.createEmptyBorder(20, 20, 20, 0));
	...
	public Frame_Pinjam_Komunal_ListPeminjaman(Main main) {
		this.main = main;
		init();
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(obj.equals(btn_form)) {	
			this.dispose();
			form_peminjaman = new Frame_Pinjam_Komunal_FormPeminjaman(main);
