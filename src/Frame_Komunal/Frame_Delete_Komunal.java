...
public class Frame_Delete_Komunal extends JFrame implements ActionListener,WindowListener{
    ...
    private JLabel lbltitle = new JLabel("HAPUS KOMUNAL");
...
//                    System.out.println("The size of list_dapur before is : "  + main.getList_dapur().size());
                    main.getList_komunal().remove(selectedRow);
//                    System.out.println("The size of list_dapur now is : "  + main.getList_dapur().size());
    ...
    public Frame_Delete_Komunal(Main main) {
    	this.main = main;
    	init_component();
