...
public class Frame_Pinjam_MesinCuci_ListPeminjaman extends JFrame implements ActionListener,WindowListener{
	...
	private JLabel lbl_title = new JLabel("List Peminjaman Mesin Cuci");
	
	private Frame_Pinjam_MesinCuci_FormPeminjaman form_peminjaman;
...
//		pnl_north.setBorder(BorderFactory.createEmptyBorder(20, 20, 20, 0));
	...
	public Frame_Pinjam_MesinCuci_ListPeminjaman(Main main) {
		this.main = main;
		init();
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(obj.equals(btn_form)) {	
			this.dispose();
			form_peminjaman = new Frame_Pinjam_MesinCuci_FormPeminjaman(main);
