...
import Main.Main;
public class Frame_Login_Peminjam extends JFrame implements ActionListener,WindowListener{
    ...
    private JLabel lbl_login = new JLabel("Masuk sebagai Peminjam");
    ...
    private JButton btn_reg = new JButton("Klik untuk Daftar");
    ...
    private Frame_Register_Peminjam register_peminjam;
...
;
    ...
    public Frame_Login_Peminjam(Main main){
    	this.main = main;
        init_components();
    }
...
//    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(obj.equals(btn_reg)){
        	this.dispose();
        	register_peminjam = new Frame_Register_Peminjam(main);
        }
        	...
        	if(main.login_peminjam(username, password)) {
        		this.dispose();
	...
	public void windowClosing(WindowEvent e) {
		// TODO Auto-generated method stub
		System.out.println("Frame_Login_Peminjam");
		main.closeFile();
