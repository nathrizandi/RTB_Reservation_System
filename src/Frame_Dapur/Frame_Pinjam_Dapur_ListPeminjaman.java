...
import Main.Main;
import Ruangan.Dapur;

public class Frame_Pinjam_Dapur_ListPeminjaman extends JFrame implements ActionListener,WindowListener{
	...
	private JLabel lbl_title = new JLabel("List Peminjaman Dapur");
	
	private Frame_Pinjam_Dapur_FormPeminjaman form_peminjaman;
	private Frame_Pinjam_List pinjam_list;
	private Main main;
	
    private JTable table;
    private String[] column = {"Tanggal","Mulai","Selesai","Nama","Kelas","Gender","Jml tungku"};
...
//    	}
		main.sort_dapur();
		System.out.println(main.getList_dapur().size());
		for(Dapur x : main.getList_dapur()) {
			...
			String jumlah_tungku = Integer.toString(x.getJumlah_tungku());
...
//		pnl_north.setBorder(BorderFactory.createEmptyBorder(20, 20, 20, 0));
	...
	public Frame_Pinjam_Dapur_ListPeminjaman(Main main) {
		this.main = main;
		init();
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(obj.equals(btn_form)) {	
			this.dispose();
			form_peminjaman = new Frame_Pinjam_Dapur_FormPeminjaman(main);
