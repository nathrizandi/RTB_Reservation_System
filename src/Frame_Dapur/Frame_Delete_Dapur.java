...
public class Frame_Delete_Dapur extends JFrame implements ActionListener,WindowListener{
    ...
    private JLabel lbltitle = new JLabel("HAPUS DAPUR");
...
//                    System.out.println("The size of list_dapur before is : "  + main.getList_dapur().size());
                    main.getList_dapur().remove(selectedRow);
//                    System.out.println("The size of list_dapur now is : "  + main.getList_dapur().size());
    ...
    public Frame_Delete_Dapur(Main main) {
    	this.main = main;
    	init_component();
